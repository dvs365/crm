...
<div workarea>
    <div colswr="1">
        <div colcont clearfix>
            ...
            <div cards>
                <p important><?= Html::a('Важные', 'javascript:void(0)', ['not-link' => '', 'id' => 'flag'])?><?= Html::a('Текущие', 'javascript:void(0)', ['not-link' => '', 'id' => 'current'])?><?= Html::a('Просроченные', 'javascript:void(0)', ['not-link' => '', 'id' => 'missed'])?></p>
                <div all>
                    <table>
                        ...
                        <? foreach ($models as $model) {?>
                            ...
                            <tr <?= (($model->client->name) ? 'flag ' : '') . (($model->time_to < $date->format('Y-m-d H:i')) ? 'missed' : 'current')?>>
